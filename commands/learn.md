---
description: Explicitly teach Claude something new about this project. Written to memory/MEMORY.md with confidence:high so it applies to all future sessions.
---
...
The agent will:
1. Read `memory/MEMORY.md` to check for duplicates
